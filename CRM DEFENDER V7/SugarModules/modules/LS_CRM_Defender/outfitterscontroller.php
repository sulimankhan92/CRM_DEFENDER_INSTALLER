...
if($_REQUEST['method'] == 'validate') {
    ...
    //Sugar 6: /index.php?module=LS_CRM_Defender&action=outfitterscontroller&method=test&to_pdf=1
    //Sugar 7: #bwc/index.php?module=LS_CRM_Defender&action=outfitterscontroller&method=test&to_pdf=1
