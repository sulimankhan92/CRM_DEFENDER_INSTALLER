...
// 	var promiseB = findIP.then(function(result) {
// 		if (!document.getElementById('whiteList').value)
// 			document.getElementById('whiteList').value+=result;
// 		else
// 		document.getElementById('whiteList').value+="\n"+result;
// 	});
// });

	//searchLocalNetIP function
	// $("#searchLocalNetIP").click(function() {
...
//         </li>
//       </ul>
//       <button style="margin-top: 15px;" class="button" id="closePopup">Close</button>
//     `;
//
